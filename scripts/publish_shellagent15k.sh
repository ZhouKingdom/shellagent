...
# Publish the ShellAgent Harbor datasets to the Harbor registry (public).
#
...
#   bash scripts/publish_shellagent15k.sh trial     # publish the 12-task trial dataset
#   bash scripts/publish_shellagent15k.sh full      # init (if needed) + publish all 14601 tasks
#   bash scripts/publish_shellagent15k.sh both      # trial, then full
#
# Optional env vars:
...
TRIAL_DIR="rl_data/output/ShellAgent-15K-Harbor-trial"
FULL_DIR="rl_data/output/tasks_skill_tax_combined_20260506_legacy10k_new5k_harbor"
FULL_NAME="shellagent/ShellAgent-15K-Harbor"
