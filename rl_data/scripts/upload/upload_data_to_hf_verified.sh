...
#       --repo osieosie/shellagent-tasks-skill-taxonomy-20260506-legacy10k-new5k-verified
#   bash rl_data/scripts/upload/upload_data_to_hf_verified.sh --repo osieosie/shellagent-rl-v2-verified --private
...
REPO_ID="osieosie/shellagent-tasks-skill-taxonomy-20260401-10k-verified"
INPUT_DIR="/gpfs/scrubbed/osey/shellagent/rl_data/output/tasks_skill_tax_20260401_10k"
PRIVATE=""
