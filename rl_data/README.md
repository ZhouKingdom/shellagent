...
registry as **[`shellagent/ShellAgent-15K-Harbor`](https://hub.harborframework.com/datasets/shellagent/ShellAgent-15K-Harbor/latest)**
...
- To evaluate on the published `shellagent/ShellAgent-15K-Harbor` dataset: the `harbor` CLI
