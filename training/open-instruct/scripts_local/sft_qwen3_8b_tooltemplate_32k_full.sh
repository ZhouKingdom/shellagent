...
OUTPUT_DIR="/data/dhsun/zhrong/checkpoints/qwen3_8b_sft_tooltemplate_32k_full"
...
accelerate launch \
    ...
    --exp_name qwen3_8b_sft_tooltemplate_32k_full \
    ...
    --dataset_transform_fn sft_qwen_tool_tokenize_and_truncate_v1 sft_tulu_filter_v1 \
