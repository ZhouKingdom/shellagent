...
uv run python mason.py \
       --cluster ai2/jupiter \
       --image "$BEAKER_IMAGE" \
       --description "shellagent-15k DPPO Qwen35 2b" \
       --pure_docker_mode \
    ...
    --dataset_mixer_list allenai/shellagent-15k-open-instruct 1.0 \
    ...
    --tool_configs '{"task_data_hf_repo": "allenai/shellagent-15k-open-instruct", "test_timeout": 120, "image": "python:3.12-slim"}' \
    --pool_size 512 \
    --max_steps 64 \
    ...
    --output_dir /output \
    --exp_name swerl_qwen35_2b_fp32lm_dppo \
    --local_eval_every 10 \
    --save_freq 20 \
