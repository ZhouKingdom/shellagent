...
uv run python mason.py \
       --cluster ai2/jupiter \
       --image "$BEAKER_IMAGE" \
       --description "SWERL Sandbox 4-node (32 GPU) GRPO with Qwen3-4B on shellagent-skill-taxonomy" \
       --pure_docker_mode \
    ...
    --dataset_mixer_list hamishivi/swerl-combined-agent-tasks 1.0 \
    ...
    --save_traces \
    --tools swerl_sandbox \
    --tool_configs '{"task_data_hf_repo": "hamishivi/swerl-combined-agent-tasks", "test_timeout": 120, "image": "python:3.12-slim"}' \
    --pool_size 256 \
    --max_steps 100 \
    ...
    --output_dir /output \
    --exp_name swerl_sandbox_qwen3_4b_4node_shellagent_grpo \
    --local_eval_every 10 \
    --save_freq 100 \
