...
uv run python mason.py \
       --cluster ai2/jupiter \
       --image "$BEAKER_IMAGE" \
       --description "SWERL Sandbox 4-node (32 GPU) GRPO with Qwen3-4B on shellagent-10k" \
       --pure_docker_mode \
    ...
    --dataset_mixer_list hamishivi/swerl-combined-10k 1.0 \
    ...
    --output_dir /output \
    --exp_name swerl_sandbox_qwen3_4b_4node_shellagent_10k_grpo \
    --local_eval_every 10 \
    --save_freq 100 \
