...
uv run python mason.py \
       --cluster ai2/jupiter \
       --image "$BEAKER_IMAGE" \
       --description "SWERL Sandbox 4-node (32 GPU) GRPO with SFT Qwen3-4B ShellAgent" \
       --pure_docker_mode \
    ...
    --async_steps 4 \
    --model_name_or_path hamishivi/sft_qwen3_4b_shellagent_4node2203 \
    --temperature 1.0 \
    --learning_rate 1e-6 \
    ...
    --output_dir /output \
    --exp_name swerl_sandbox_qwen3_4b_sft_shellagent_4node_grpo \
    --local_eval_every 10 \
    --save_freq 100 \
