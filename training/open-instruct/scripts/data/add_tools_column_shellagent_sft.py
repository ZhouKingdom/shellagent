"""
Add a 'tools' column to hamishivi/shellagent-sft-full-20260403 containing the
SWERL bash tool definition, then push the updated dataset back to the Hub.

Usage:
    python scripts/data/add_tools_column_shellagent_sft.py
"""
from datasets import load_dataset

DATASETS = [
    "hamishivi/shellagent-sft-full-20260317",
    "hamishivi/shellagent-sft-full-20260403",
]
