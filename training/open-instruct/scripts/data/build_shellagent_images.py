#!/usr/bin/env python3
"""Build and push per-task Docker images for shellagent-tasks dataset.
...
Usage:
    python scripts/data/build_shellagent_images.py --registry hamishivi
    python scripts/data/build_shellagent_images.py --registry hamishivi --dry-run
    python scripts/data/build_shellagent_images.py --registry hamishivi --platform linux/amd64
    python scripts/data/build_shellagent_images.py --registry hamishivi --platform linux/amd64,linux/arm64 --use-buildx
"""
...
def main():
    parser = argparse.ArgumentParser(description="Build per-task Docker images for shellagent-tasks")
    parser.add_argument("--input", default="osieosie/shellagent-tasks-skill-taxonomy-20260324-1k-verified")
    parser.add_argument("--registry", default="hamishivi", help="DockerHub username/org")
    parser.add_argument("--repo-prefix", default="swerl-shellagent", help="Image repo prefix")
    parser.add_argument("--output-dataset", default="hamishivi/swerl-shellagent-skill-taxonomy-1k")
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "'hamishi740/swerl-shellagent-buildcache'). Enables "
    ...
    for row in ds:
        ...
        if not container_def:
            raise KeyError(
                ...
                "Use a source dataset that includes container_def (for example osieosie/shellagent-tasks-*)."
            )
