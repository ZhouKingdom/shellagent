#!/usr/bin/env python3
"""Convert osieosie/shellagent-tasks-* dataset to SWERL sandbox format.
    ...
    with tarfile.open(fileobj=tar_stream, mode="w:gz") as tar:
        for row in ds:
            ...
            records.append({
                ...
                "source": "shellagent_skill_taxonomy",
            })
...
def main():
    parser = argparse.ArgumentParser(description="Convert shellagent-tasks dataset to SWERL format")
    ...
    parser.add_argument("--output-tarball", default="data/shellagent-task-data.tar.gz")
