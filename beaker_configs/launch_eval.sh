...
BUDGET=""
PRIORITY="urgent"
BEAKER_WORKSPACE="${BEAKER_WORKSPACE:-ai2/shellagent}"
BEAKER_IMAGE="${BEAKER_IMAGE:-hamishivi/shellagent-eval-interactive}"
...
Options:
  ...
  --workspace WS         beaker workspace (default: \$BEAKER_WORKSPACE or ai2/shellagent)
  ...
  --repo-url URL         git URL of shellagent (default: current 'origin' remote)
  --repo-ref REF         git SHA/branch of shellagent (default: current HEAD SHA)
...
cat <<EOF
=== Launching shellagent eval on Beaker ===
